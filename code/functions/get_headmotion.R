  ...
  #read subj list
  subjlist <- read.table("~/Dropbox/Sid/R_files/STAGES_difussion/data/squad_headmotion/subjlist.txt")
  squadjson <- jsonlite::read_json("~/Dropbox/Sid/R_files/STAGES_difussion/data/squad_headmotion/group_db.json")
